...
const SingleRecievedMessage: React.FC<SingleMessageProps> = ({ chat }) => {
  return (
    <>
      <div className="text-md flex flex-col items-start gap-5 p-4 text-gray-900">
...
export default SingleRecievedMessage
